...
def redact_args(args: list[str]) -> list[str]:
    ...
    for arg in args:
        ...
        if arg.startswith("--"):
            ...
            sensitive = normalized.endswith("_token") or any(token in normalized for token in _SENSITIVE_TOKENS)
...
def _environment(
    ...
    *,
    ...
    modules = executable.release.root / "modules"
    if modules.is_dir():
        python_paths.append(str(modules))
    python_paths.append(str(paths.home / "lib/python"))
